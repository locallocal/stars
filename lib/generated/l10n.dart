...
class S {
  ...
  String get chatVerificationStatus {
    return Intl.message(
      'Verification status',
      name: 'chatVerificationStatus',
      desc: '',
      args: [],
    );
  }

  /// `Show verification status and details in assistant messages.`
  String get showVerificationStatusDescription {
    return Intl.message(
      'Show verification status and details in assistant messages.',
      name: 'showVerificationStatusDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get hideConversationInformation {
    return Intl.message(
      'Hide Conversation Info',
      name: 'hideConversationInformation',
      desc: '',
      args: [],
    );
  }
  ...
  String get showConversationInformation {
    return Intl.message(
      'Show Conversation Info',
      name: 'showConversationInformation',
      desc: '',
      args: [],
    );
  }
  ...
  String get conversationInformation {
    return Intl.message(
      'Conversation Information',
  ...
  String get conversationProviderDescription {
    return Intl.message(
      'The provider supplying the model service for this conversation.',
      name: 'conversationProviderDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get conversationModelDescription {
    return Intl.message(
      'The model used to generate replies in this conversation.',
      name: 'conversationModelDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get modelInputModalitiesDescription {
    return Intl.message(
      'The content types this model can process.',
      name: 'modelInputModalitiesDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get modelOutputModalitiesDescription {
    return Intl.message(
      'The content types this model can generate.',
      name: 'modelOutputModalitiesDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get webSearchDescription {
    return Intl.message(
      'Allow the model to search the web for up-to-date information.',
      name: 'webSearchDescription',
      desc: '',
      args: [],
    );
  }

  /// `Allow the model to reason more deeply before responding.`
  String get deepThinkingDescription {
    return Intl.message(
      'Allow the model to reason more deeply before responding.',
      name: 'deepThinkingDescription',
      desc: '',
      args: [],
    );
  }

  /// `Total input and output tokens used during the selected period.`
  String get totalTokensDescription {
    return Intl.message(
      'Total input and output tokens used during the selected period.',
      name: 'totalTokensDescription',
      desc: '',
      args: [],
    );
  }

  /// `Tokens sent to the model, including conversation context and instructions.`
  String get inputTokensDescription {
    return Intl.message(
      'Tokens sent to the model, including conversation context and instructions.',
      name: 'inputTokensDescription',
      desc: '',
      args: [],
    );
  }

  /// `Tokens generated by the model in replies.`
  String get outputTokensDescription {
    return Intl.message(
      'Tokens generated by the model in replies.',
      name: 'outputTokensDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get contextWindowDescription {
    return Intl.message(
      'Maximum tokens the model can consider in one request.',
      name: 'contextWindowDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get estimatedContextUsageDescription {
    return Intl.message(
      'Estimated tokens for the next request compared with the available input budget.',
      name: 'estimatedContextUsageDescription',
      desc: '',
      args: [],
    );
  }

  /// `Recent conversation turns kept in their original form.`
  String get retainedRecentTurnsDescription {
    return Intl.message(
      'Recent conversation turns kept in their original form.',
      name: 'retainedRecentTurnsDescription',
      desc: '',
      args: [],
    );
  }

  /// `Messages already compressed into the conversation summary.`
  String get summarizedTurnsDescription {
    return Intl.message(
      'Messages already compressed into the conversation summary.',
      name: 'summarizedTurnsDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get compactionStatusDescription {
    return Intl.message(
      'Current status of automatic conversation context compaction.',
      name: 'compactionStatusDescription',
      desc: '',
      args: [],
    );
  }

  /// `Automatically summarize older messages when the context needs space.`
  String get automaticMemoryDescription {
    return Intl.message(
      'Automatically summarize older messages when the context needs space.',
      name: 'automaticMemoryDescription',
      desc: '',
      args: [],
    );
  }
  ...
  /// `User messages`
  String get userMessageNavigation {
    return Intl.message(
      'User messages',
      name: 'userMessageNavigation',
      desc:
          'Accessible label for the user-message anchor rail beside the conversation',
      args: [],
    );
  }

  /// `Jump to user message {index}: {summary}`
  String jumpToUserMessage(int index, String summary) {
    return Intl.message(
      'Jump to user message $index: $summary',
      name: 'jumpToUserMessage',
      desc: 'Accessible action label for a message anchor',
      args: [index, summary],
    );
  }
}
