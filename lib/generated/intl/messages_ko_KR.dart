...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(name) => "봇 \"${name}\"이(가) 추가되었습니다";

  static String m2(botName) => "\"${botName}\"이(가) 삭제되었습니다";

  static String m3(botName) =>
      "안녕하세요! 저는 ${botName}이라는 AI 어시스턴트입니다. 어떤 질문이든 편하게 물어보세요, 최선을 다해 도와드리겠습니다.";

  static String m4(botName) => "${botName}이(가) 입력 중...";

  static String m5(botName) => "봇 ${botName}이(가) 업데이트되었습니다";

  static String m6(botName) => "${botName}와(과)의 채팅이 삭제되었습니다";
  ...
  static String m12(name) => "${name} 스킬을 제거할까요? 봇 연결도 함께 삭제됩니다.";

  static String m13(year) => "© ${year} Stars 팀";
  ...
  static String m25(index, summary) => "사용자 메시지 ${index}(으)로 이동: ${summary}";

  static String m26(language) => "언어가 ${language}(으)로 설정되었습니다";

  static String m27(error) => "MCP connection failed: ${error}";

  static String m28(count) => "${count} configured (values hidden)";

  static String m29(minutes) => "${minutes}분 전";

  static String m30(count) => "${count}개의 모델을 성공적으로 검색했습니다";

  static String m31(count) => "명령 실행 ${count}회";

  static String m32(duration) => "소요 시간 ${duration}";

  static String m33(count) => "파일 변경 ${count}건";

  static String m34(count) => "도구 호출 ${count}회";

  static String m35(error) => "응답을 가져오지 못했습니다: ${error}";
  ...
  static String m40(duration) => "생각 완료 · ${duration}";

  static String m41(error) => "동영상 재생 오류: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "answerTrustReasonGenerationTimedOut": MessageLookupByLibrary.simpleMessage(
      "최종 응답 검증이 완료되기 전에 생성 시간이 초과되었습니다. 완료된 도구 증거는 계속 확인할 수 있습니다.",
    ),
    ...
    "answerTrustReasonProviderUnsupported":
        MessageLookupByLibrary.simpleMessage("이 제공자는 검증 도구를 지원하지 않습니다."),
    ...
    "deletedConversations": MessageLookupByLibrary.simpleMessage("삭제된 대화"),
    ...
    "memoryUserAssertion": MessageLookupByLibrary.simpleMessage("사용자 진술"),
    ...
    "userMessageNavigation": MessageLookupByLibrary.simpleMessage("사용자 메시지"),
