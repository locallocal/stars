...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(name) => "Bot \"${name}\" has been added";

  static String m2(botName) => "\"${botName}\" has been deleted";

  static String m3(botName) =>
      "Hello! I\'m ${botName}, an AI assistant. Feel free to ask me anything, and I\'ll do my best to help you.";

  static String m4(botName) => "${botName} is typing...";

  static String m5(botName) => "Bot ${botName} has been updated";

  static String m6(botName) => "Chat with ${botName} deleted";
  ...
  static String m26(language) => "Language set to ${language}";

  static String m27(error) => "MCP connection failed: ${error}";

  static String m28(count) => "${count} configured (values hidden)";

  static String m29(minutes) => "${minutes} minutes ago";

  static String m30(count) => "Successfully retrieved ${count} models";

  static String m31(count) => "${count} command runs";

  static String m32(duration) => "Duration ${duration}";

  static String m33(count) => "${count} file updates";

  static String m34(count) => "${count} tool calls";

  static String m35(error) => "Failed to get response: ${error}";
  ...
  static String m40(duration) => "Thinking complete · ${duration}";

  static String m41(error) => "Video playback error: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "answerTrustEvidence": MessageLookupByLibrary.simpleMessage("Evidence"),
    ...
    "answerTrustFailed": MessageLookupByLibrary.simpleMessage("Failed"),
    ...
    "answerTrustObservedAt": MessageLookupByLibrary.simpleMessage("Observed"),
    ...
    "answerTrustTool": MessageLookupByLibrary.simpleMessage("Tool"),
    "answerTrustUnverified": MessageLookupByLibrary.simpleMessage("Unverified"),
    "answerTrustVerified": MessageLookupByLibrary.simpleMessage("Verified"),
