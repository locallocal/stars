...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(name) => "智能体 \"${name}\" 已添加";

  static String m2(botName) => "\"${botName}\" 已被删除";

  static String m3(botName) => "你好！我是${botName}，一个AI助手。请随时向我提问，我会尽力帮助你。";

  static String m4(botName) => "${botName}正在输入...";

  static String m5(botName) => "智能体 ${botName} 已更新";

  static String m6(botName) => "已删除与 ${botName} 的聊天";

  static String m7(error) => "清空聊天记录失败：${error}";

  static String m8(botName) => "确定要清空与 \"${botName}\" 的所有聊天记录吗？此操作不可恢复。";

  static String m9(botName) => "删除机器人会删除对应的聊天记录，确定要删除 ${botName} 吗？";

  static String m10(botName) => "删除聊天会清空所有的聊天记录，确定要删除与 ${botName} 的聊天吗？";

  static String m11(name) => "确定删除“${name}”？缓存的工具目录和安全凭据也会一并移除。";

  static String m12(name) => "确定卸载技能“${name}”？相关智能体绑定也会被移除。";

  static String m13(year) => "© ${year} Stars 团队";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "answerTrustReasonProviderUnsupported":
        MessageLookupByLibrary.simpleMessage("当前 Provider 不支持验证工具。"),
    ...
    "applicationInjectedPromptDescription":
        MessageLookupByLibrary.simpleMessage(
          "由 Stars 管理。开启后会把以下内容注入会话模型请求，关闭后不注入；必要的运行时会话上下文不受此开关影响。内容不可编辑。",
        ),
    ...
    "botDeleted": m2,
    "botExportFailed": MessageLookupByLibrary.simpleMessage("无法导出智能体，请重试。"),
    "botExportSucceeded": MessageLookupByLibrary.simpleMessage("智能体已导出"),
    "botExportedWithoutSecrets": MessageLookupByLibrary.simpleMessage(
      "智能体导出文件始终不会包含 API 密钥。",
    ),
    "botGreeting": m3,
    "botImportFailed": MessageLookupByLibrary.simpleMessage(
      "无法导入智能体，请检查文件后重试。",
    ),
    "botImportSucceeded": MessageLookupByLibrary.simpleMessage("智能体已导入"),
    "botImportedWithoutApiKey": MessageLookupByLibrary.simpleMessage(
      "为保障安全，API 密钥不会被导入。使用此智能体前请重新配置密钥。",
    ),
    ...
    "chatReasoning": MessageLookupByLibrary.simpleMessage("思考过程"),
    "chatSearchScope": MessageLookupByLibrary.simpleMessage(
      "搜索会匹配会话名称、智能体名称和最后一条消息。",
    ),
    "chatVerificationStatus": MessageLookupByLibrary.simpleMessage("核验检查"),
    ...
    "configureApiKey": MessageLookupByLibrary.simpleMessage("配置 API 密钥"),
    ...
    "conversationDataMenuLabel": MessageLookupByLibrary.simpleMessage("数据"),
    ...
    "conversationFileSearchEmptyDescription":
        MessageLookupByLibrary.simpleMessage("试试其他文件或文件夹名称，或清除搜索。"),
    ...
    "conversationName": MessageLookupByLibrary.simpleMessage("会话名称"),
    ...
    "importBot": MessageLookupByLibrary.simpleMessage("导入智能体"),
    ...
    "modelLogCopied": MessageLookupByLibrary.simpleMessage("已复制"),
    "modelLogCopyFailed": MessageLookupByLibrary.simpleMessage(
      "无法复制路径，可选中路径后手动复制。",
    ),
    "modelLogCopyPath": MessageLookupByLibrary.simpleMessage("复制路径"),
    "modelLogDirectory": MessageLookupByLibrary.simpleMessage("本会话日志目录"),
    "modelLogLoadFailed": MessageLookupByLibrary.simpleMessage("无法读取日志设置，请重试。"),
    "modelLogOpenDirectory": MessageLookupByLibrary.simpleMessage("打开目录"),
    ...
    "renameConversation": MessageLookupByLibrary.simpleMessage("修改会话名称"),
