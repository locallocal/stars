...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(name) => "Бот \"${name}\" был добавлен";

  static String m2(botName) => "\"${botName}\" был удален";
  ...
  static String m4(botName) => "${botName} печатает...";

  static String m5(botName) => "Бот ${botName} был обновлен";

  static String m6(botName) => "Чат с ${botName} удален";
  ...
  static String m13(year) => "© ${year} Команда Stars";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "answerTrustReasonProviderUnsupported":
        MessageLookupByLibrary.simpleMessage(
          "Этот провайдер не поддерживает инструменты проверки.",
        ),
    "answerTrustReasonToolRejected": MessageLookupByLibrary.simpleMessage(
      "Запрос к инструменту проверки был отклонён.",
    ),
    ...
    "conversationFileSearchEmptyDescription":
        MessageLookupByLibrary.simpleMessage(
          "Попробуйте другое имя файла или папки либо очистите поиск.",
        ),
    "conversationFileSearchScope": MessageLookupByLibrary.simpleMessage(
      "Поиск выполняется по именам файлов и папок в текущем каталоге.",
    ),
    ...
    "exportAction": MessageLookupByLibrary.simpleMessage("Экспортировать"),
    ...
    "maxToolRequestRounds": MessageLookupByLibrary.simpleMessage(
      "Лимит раундов запросов инструментов",
    ),
    "maxToolRequestRoundsDescription": MessageLookupByLibrary.simpleMessage(
      "Максимальное число раундов модели, в которых можно запрашивать инструменты за один ответ. Настройка применяется только к этому диалогу.",
    ),
    ...
    "maxToolRequestRoundsSaved": MessageLookupByLibrary.simpleMessage(
      "Лимит раундов запросов инструментов обновлён.",
    ),
