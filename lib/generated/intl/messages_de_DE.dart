...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(name) => "Bot \"${name}\" wurde hinzugefügt";

  static String m2(botName) => "\"${botName}\" wurde gelöscht";
  ...
  static String m4(botName) => "${botName} schreibt...";

  static String m5(botName) => "Bot ${botName} wurde aktualisiert";

  static String m6(botName) => "Chat mit ${botName} wurde gelöscht";
  ...
  static String m13(year) => "© ${year} Stars-Team";
  ...
  static String m25(index, summary) =>
      "Zu Benutzernachricht ${index} springen: ${summary}";

  static String m26(language) => "Sprache auf ${language} eingestellt";

  static String m27(error) => "MCP connection failed: ${error}";

  static String m28(count) => "${count} configured (values hidden)";

  static String m29(minutes) => "vor ${minutes} Minuten";

  static String m30(count) => "Erfolgreich ${count} Modelle abgerufen";

  static String m31(count) => "${count} Befehlsausführungen";

  static String m32(duration) => "Dauer ${duration}";

  static String m33(count) => "${count} Dateiänderungen";

  static String m34(count) => "${count} Tool-Aufrufe";

  static String m35(error) => "Antwort konnte nicht abgerufen werden: ${error}";
  ...
  static String m39(question, reason) =>
      "Ich kann „${question}“ nicht zuverlässig faktisch beantworten und werde daher nicht raten.\n\nVerifizierungsstatus: ${reason}\n\nSie können die Nachweisdetails prüfen, eine verlässliche Quelle angeben oder mich um eine erneute Verifizierung bitten.";

  static String m40(duration) => "Denken abgeschlossen · ${duration}";

  static String m41(error) => "Fehler bei der Videowiedergabe: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "answerTrustClaimHidden": MessageLookupByLibrary.simpleMessage(
      "Die Tatsachenbehauptung wurde im strengen Modus ausgeblendet.",
    ),
    "answerTrustDetails": MessageLookupByLibrary.simpleMessage(
      "Nachweisdetails anzeigen",
    ),
    "answerTrustEvidence": MessageLookupByLibrary.simpleMessage("Nachweis"),
    "answerTrustEvidenceUnavailable": MessageLookupByLibrary.simpleMessage(
      "Nachweisdetails sind nicht verfügbar.",
    ),
    ...
    "answerTrustFailed": MessageLookupByLibrary.simpleMessage("Fehlgeschlagen"),
    ...
    "answerTrustObservedAt": MessageLookupByLibrary.simpleMessage("Beobachtet"),
    ...
    "answerTrustReasonEvidenceExpired": MessageLookupByLibrary.simpleMessage(
      "Die unterstützende Beobachtung ist abgelaufen.",
    ),
    "answerTrustReasonGateFailed": MessageLookupByLibrary.simpleMessage(
      "Diese Antwort hat die Vertrauensprüfung der Anwendung nicht bestanden.",
    ),
    "answerTrustReasonGenerationTimedOut": MessageLookupByLibrary.simpleMessage(
      "Die Generierung wurde vor Abschluss der Verifizierung der endgültigen Antwort wegen Zeitüberschreitung beendet. Abgeschlossene Tool-Belege bleiben verfügbar.",
    ),
    "answerTrustReasonNoTool": MessageLookupByLibrary.simpleMessage(
      "Für diese Antwort sind keine nutzbaren Tool-Belege verfügbar.",
    ),
    "answerTrustReasonNotFactChecked": MessageLookupByLibrary.simpleMessage(
      "Dieser Inhalt ist kreativ oder wird nicht als verifizierte Tatsache dargestellt.",
    ),
    "answerTrustReasonPartiallyVerified": MessageLookupByLibrary.simpleMessage(
      "Nur einige Tatsachenbehauptungen werden durch gespeicherte Nachweise gestützt.",
    ),
    "answerTrustReasonProviderFailed": MessageLookupByLibrary.simpleMessage(
      "Die Provider-Anfrage ist fehlgeschlagen, bevor diese Antwort verifiziert werden konnte.",
    ),
    "answerTrustReasonProviderUnsupported":
        MessageLookupByLibrary.simpleMessage(
          "Dieser Provider unterstützt keine Verifizierungs-Tools.",
        ),
    "answerTrustReasonToolRejected": MessageLookupByLibrary.simpleMessage(
      "Die Anfrage an das Verifizierungs-Tool wurde abgelehnt.",
    ),
    "answerTrustReasonUnavailable": MessageLookupByLibrary.simpleMessage(
      "Die Verifizierung dieser Antwort wurde nicht abgeschlossen.",
    ),
    "answerTrustReasonVerified": MessageLookupByLibrary.simpleMessage(
      "Alle Tatsachenbehauptungen werden durch gespeicherte Nachweise gestützt.",
    ),
    "answerTrustSemanticLabel": m0,
    "answerTrustSource": MessageLookupByLibrary.simpleMessage("Quelle"),
    "answerTrustTool": MessageLookupByLibrary.simpleMessage("Werkzeug"),
    "answerTrustUnverified": MessageLookupByLibrary.simpleMessage(
      "Nicht verifiziert",
    ),
    "answerTrustVerified": MessageLookupByLibrary.simpleMessage("Verifiziert"),
    ...
    "automaticMemoryDescription": MessageLookupByLibrary.simpleMessage(
      "Fasst ältere Nachrichten automatisch zusammen, wenn Kontextplatz benötigt wird.",
    ),
    ...
    "chatReasoning": MessageLookupByLibrary.simpleMessage("Denkprozess"),
    ...
    "contextWindowDescription": MessageLookupByLibrary.simpleMessage(
      "Maximale Anzahl an Token, die das Modell in einer Anfrage berücksichtigen kann.",
    ),
    "conversationBotDescription": MessageLookupByLibrary.simpleMessage(
      "Der für diese Unterhaltung verwendete Bot.",
    ),
    ...
    "deepThinkingDescription": MessageLookupByLibrary.simpleMessage(
      "Erlaubt dem Modell, vor der Antwort ausführlicher nachzudenken.",
    ),
    ...
    "estimatedContextUsageDescription": MessageLookupByLibrary.simpleMessage(
      "Geschätzte Token der nächsten Anfrage im Verhältnis zum verfügbaren Eingabebudget.",
    ),
    ...
    "inputTokensDescription": MessageLookupByLibrary.simpleMessage(
      "An das Modell gesendete Token, einschließlich Gesprächskontext und Anweisungen.",
    ),
    ...
    "maxToolRequestRounds": MessageLookupByLibrary.simpleMessage(
      "Limit für Werkzeuganfragerunden",
    ),
    "maxToolRequestRoundsDescription": MessageLookupByLibrary.simpleMessage(
      "Maximale Anzahl von Modellrunden, die in einer Antwort Werkzeuge anfordern dürfen. Diese Einstellung gilt nur für diese Unterhaltung.",
    ),
    "maxToolRequestRoundsRange": MessageLookupByLibrary.simpleMessage(
      "Geben Sie eine ganze Zahl zwischen 1 und 50 ein.",
    ),
    "maxToolRequestRoundsSaved": MessageLookupByLibrary.simpleMessage(
      "Limit für Werkzeuganfragerunden aktualisiert.",
    ),
    ...
    "outputTokensDescription": MessageLookupByLibrary.simpleMessage(
      "Vom Modell in Antworten erzeugte Token.",
    ),
    ...
    "renameConversationDescription": MessageLookupByLibrary.simpleMessage(
      "Wähle einen eindeutigen Namen, um diese Unterhaltung schneller zu finden.",
    ),
    ...
    "retainedRecentTurnsDescription": MessageLookupByLibrary.simpleMessage(
      "Letzte Gesprächsrunden, die im Original erhalten bleiben.",
    ),
    ...
    "showReasoningDescription": MessageLookupByLibrary.simpleMessage(
      "Zeigt den Denkprozess in Assistentennachrichten an.",
    ),
    ...
    "showVerificationStatusDescription": MessageLookupByLibrary.simpleMessage(
      "Zeigt den Prüfstatus und die Details in Assistentennachrichten an.",
    ),
    ...
    "strictGroundingMode": MessageLookupByLibrary.simpleMessage(
      "Strenger Verifizierungsmodus",
    ),
    "strictGroundingModeDescription": MessageLookupByLibrary.simpleMessage(
      "Blendet nicht verifizierte Tatsachenantworten aus und erhält Verifizierungs- und Werkzeugfehlerdetails.",
    ),
    "strictGroundingUnableToVerify": MessageLookupByLibrary.simpleMessage(
      "Mir liegen nicht genügend verlässliche Belege für eine faktische Antwort vor, daher werde ich nicht raten. Prüfen Sie die Nachweisdetails, geben Sie eine verlässliche Quelle an oder bitten Sie mich um eine erneute Verifizierung.",
    ),
    ...
    "summarizedTurnsDescription": MessageLookupByLibrary.simpleMessage(
      "Nachrichten, die bereits in der Gesprächszusammenfassung komprimiert wurden.",
    ),
    ...
    "toolStateNotReadBackVerified": MessageLookupByLibrary.simpleMessage(
      "Status nicht verifiziert zurückgelesen",
    ),
    "toolStateReadBackVerified": MessageLookupByLibrary.simpleMessage(
      "Status zurückgelesen und verifiziert",
    ),
    ...
    "totalTokensDescription": MessageLookupByLibrary.simpleMessage(
      "Summe der Eingabe- und Ausgabetoken im ausgewählten Zeitraum.",
    ),
    ...
    "unableToRenameConversation": MessageLookupByLibrary.simpleMessage(
      "Unterhaltung konnte nicht umbenannt werden",
    ),
    ...
    "webSearchDescription": MessageLookupByLibrary.simpleMessage(
      "Erlaubt dem Modell, im Web nach aktuellen Informationen zu suchen.",
    ),
  };
}
