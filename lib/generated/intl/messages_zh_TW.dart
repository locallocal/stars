...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(name) => "智能體 \"${name}\" 已添加";

  static String m2(botName) => "\"${botName}\" 已被刪除";

  static String m3(botName) => "你好！我是 ${botName}，一個AI助手。你可以問我任何問題，我會盡力幫助你。";

  static String m4(botName) => "${botName} 正在輸入...";

  static String m5(botName) => "智能體 ${botName} 已更新";

  static String m6(botName) => "已刪除與 ${botName} 的聊天";

  static String m7(error) => "Could not clear chat history: ${error}";

  static String m8(botName) => "確定要清空與 \"${botName}\" 的所有聊天記錄嗎？此操作無法撤銷。";

  static String m9(botName) => "刪除智能體會刪除對應的聊天記錄，確定要刪除 ${botName} 嗎？";

  static String m10(botName) => "刪除聊天會清空所有的聊天記錄，確定要刪除與 ${botName} 的聊天嗎？";

  static String m11(name) => "確定刪除「${name}」？快取的工具目錄與安全憑證也會移除。";

  static String m12(name) => "確定解除安裝技能「${name}」？相關智慧體綁定也會被移除。";

  static String m13(year) => "© ${year} Stars 團隊";
  ...
  static String m25(index, summary) => "跳至第 ${index} 則使用者訊息：${summary}";

  static String m26(language) => "語言已設置為${language}";

  static String m27(error) => "MCP 連線失敗：${error}";

  static String m28(count) => "${count} configured (values hidden)";

  static String m29(minutes) => "${minutes}分鐘前";

  static String m30(count) => "成功獲取 ${count} 個模型";

  static String m31(count) => "${count} 次命令執行";

  static String m32(duration) => "耗時 ${duration}";

  static String m33(count) => "${count} 筆檔案狀態";

  static String m34(count) => "${count} 次工具呼叫";

  static String m35(error) => "獲取回覆失敗: ${error}";
  ...
  static String m39(question, reason) =>
      "關於「${question}」，我暫時無法提供可靠的事實結論，因此不會猜測。\n\n驗證情況：${reason}\n\n你可以查看證據詳情、補充可靠來源，或請我重新驗證。";

  static String m40(duration) => "思考完成 · ${duration}";

  static String m41(error) => "影片播放錯誤：${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addBot": MessageLookupByLibrary.simpleMessage("添加智能體"),
    ...
    "answerTrustReasonProviderUnsupported":
        MessageLookupByLibrary.simpleMessage("目前的 Provider 不支援驗證工具。"),
    ...
    "botName": MessageLookupByLibrary.simpleMessage("智能體名稱"),
    "botSearchScope": MessageLookupByLibrary.simpleMessage("搜尋會依智能體名稱篩選清單。"),
    ...
    "editBot": MessageLookupByLibrary.simpleMessage("編輯智能體"),
    ...
    "maxToolRequestRounds": MessageLookupByLibrary.simpleMessage("工具請求回合上限"),
    "maxToolRequestRoundsDescription": MessageLookupByLibrary.simpleMessage(
      "單次回覆中允許模型請求工具的最大回合數。此設定僅套用於目前對話。",
    ),
    ...
    "memoryUserAssertion": MessageLookupByLibrary.simpleMessage("使用者陳述"),
    ...
    "minutesAgo": m29,
    "modalityAudio": MessageLookupByLibrary.simpleMessage("音訊"),
    "modalityFile": MessageLookupByLibrary.simpleMessage("檔案"),
    "modalityImage": MessageLookupByLibrary.simpleMessage("圖片"),
    "modalityMulti": MessageLookupByLibrary.simpleMessage("多模態"),
    "modalityMusic": MessageLookupByLibrary.simpleMessage("音樂"),
    "modalityRealtime": MessageLookupByLibrary.simpleMessage("即時"),
    "modalitySpeech": MessageLookupByLibrary.simpleMessage("語音"),
    "modalityText": MessageLookupByLibrary.simpleMessage("文字"),
    ...
    "noMatchingBots": MessageLookupByLibrary.simpleMessage("找不到符合的智能體"),
    ...
    "providerInformation": MessageLookupByLibrary.simpleMessage("供應商資訊"),
    ...
    "strictGroundingUnableToVerify": MessageLookupByLibrary.simpleMessage(
      "我暫時沒有取得足夠可靠的證據，因此不會提供可能不準確的事實結論。你可以查看證據詳情、補充可靠來源，或請我重新驗證。",
    ),
    ...
    "userMessageNavigation": MessageLookupByLibrary.simpleMessage("使用者訊息"),
