...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(name) => "Bot \"${name}\" a été ajouté";

  static String m2(botName) => "\"${botName}\" a été supprimé";
  ...
  static String m4(botName) => "${botName} est en train d\'écrire...";

  static String m5(botName) => "Bot ${botName} a été mis à jour";

  static String m6(botName) => "Discussion avec ${botName} supprimée";
  ...
  static String m13(year) => "© ${year} Équipe Stars";
  ...
  static String m25(index, summary) =>
      "Aller au message utilisateur ${index} : ${summary}";

  static String m26(language) => "Langue définie sur ${language}";

  static String m27(error) => "MCP connection failed: ${error}";

  static String m28(count) => "${count} configured (values hidden)";

  static String m29(minutes) => "il y a ${minutes} minutes";

  static String m30(count) => "${count} modèles récupérés avec succès";

  static String m31(count) => "${count} exécutions de commandes";

  static String m32(duration) => "Durée ${duration}";

  static String m33(count) => "${count} modifications de fichiers";

  static String m34(count) => "${count} appels d’outil";

  static String m35(error) => "Échec de récupération de la réponse: ${error}";
  ...
  static String m40(duration) => "Réflexion terminée · ${duration}";

  static String m41(error) => "Erreur de lecture vidéo : ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "answerTrustReasonProviderUnsupported":
        MessageLookupByLibrary.simpleMessage(
          "Ce fournisseur ne prend pas en charge les outils de vérification.",
        ),
    "answerTrustReasonToolRejected": MessageLookupByLibrary.simpleMessage(
      "La demande d\'outil de vérification a été refusée.",
    ),
    ...
    "conversationDataMenuLabel": MessageLookupByLibrary.simpleMessage(
      "Données",
    ),
    ...
    "hideConversationInformation": MessageLookupByLibrary.simpleMessage(
      "Masquer les informations de la conversation",
    ),
    ...
    "maxToolRequestRounds": MessageLookupByLibrary.simpleMessage(
      "Limite des tours d’outils",
    ),
    "maxToolRequestRoundsDescription": MessageLookupByLibrary.simpleMessage(
      "Nombre maximal de tours du modèle pouvant demander des outils dans une réponse. Ce réglage s’applique uniquement à cette conversation.",
    ),
    ...
    "maxToolRequestRoundsSaved": MessageLookupByLibrary.simpleMessage(
      "Limite des tours d’outils mise à jour.",
    ),
