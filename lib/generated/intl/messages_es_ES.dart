...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(name) => "Bot \"${name}\" ha sido añadido";

  static String m2(botName) => "\"${botName}\" ha sido eliminado";
  ...
  static String m4(botName) => "${botName} está escribiendo...";

  static String m5(botName) => "Bot ${botName} ha sido actualizado";

  static String m6(botName) => "Chat con ${botName} eliminado";
  ...
  static String m13(year) => "© ${year} Equipo Stars";
  ...
  static String m25(index, summary) =>
      "Ir al mensaje del usuario ${index}: ${summary}";

  static String m26(language) => "Idioma cambiado a ${language}";

  static String m27(error) => "MCP connection failed: ${error}";

  static String m28(count) => "${count} configured (values hidden)";

  static String m29(minutes) => "hace ${minutes} minutos";

  static String m30(count) => "Se han recuperado ${count} modelos con éxito";

  static String m31(count) => "${count} ejecuciones de comandos";

  static String m32(duration) => "Duración ${duration}";

  static String m33(count) => "${count} cambios de archivos";

  static String m34(count) => "${count} llamadas a herramientas";

  static String m35(error) => "Error al obtener respuesta: ${error}";
  ...
  static String m40(duration) => "Pensamiento completado · ${duration}";

  static String m41(error) => "Error de reproducción de vídeo: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "answerTrustReasonGenerationTimedOut": MessageLookupByLibrary.simpleMessage(
      "La generación agotó el tiempo antes de verificar la respuesta final. La evidencia de herramientas completada sigue disponible.",
    ),
    ...
    "answerTrustReasonProviderUnsupported":
        MessageLookupByLibrary.simpleMessage(
          "Este proveedor no admite herramientas de verificación.",
        ),
    "answerTrustReasonToolRejected": MessageLookupByLibrary.simpleMessage(
      "La solicitud de la herramienta de verificación fue rechazada.",
    ),
    ...
    "automaticMemoryDescription": MessageLookupByLibrary.simpleMessage(
      "Resume automáticamente los mensajes antiguos cuando el contexto necesita espacio.",
    ),
    ...
    "botExportFailed": MessageLookupByLibrary.simpleMessage(
      "No se pudo exportar el bot. Inténtalo de nuevo.",
    ),
    ...
    "botExportedWithoutSecrets": MessageLookupByLibrary.simpleMessage(
      "Las claves de API nunca se incluyen en los archivos de exportación de bots.",
    ),
    "botGreeting": m3,
    "botImportFailed": MessageLookupByLibrary.simpleMessage(
      "No se pudo importar el bot. Comprueba el archivo e inténtalo de nuevo.",
    ),
    ...
    "botImportedWithoutApiKey": MessageLookupByLibrary.simpleMessage(
      "Por seguridad, las claves de API no se importan. Añade una antes de usar este bot.",
    ),
    ...
    "compactionStatusDescription": MessageLookupByLibrary.simpleMessage(
      "Estado actual de la compactación automática del contexto.",
    ),
    ...
    "contextWindowDescription": MessageLookupByLibrary.simpleMessage(
      "Número máximo de tokens que el modelo puede considerar en una solicitud.",
    ),
    "conversationBotDescription": MessageLookupByLibrary.simpleMessage(
      "El bot utilizado en esta conversación.",
    ),
    "conversationClearMenuLabel": MessageLookupByLibrary.simpleMessage(
      "Vaciar",
    ),
    "conversationDataMenuLabel": MessageLookupByLibrary.simpleMessage("Datos"),
    ...
    "conversationFileSearchEmptyDescription":
        MessageLookupByLibrary.simpleMessage(
          "Prueba otro nombre de archivo o carpeta, o borra la búsqueda.",
        ),
    "conversationFileSearchScope": MessageLookupByLibrary.simpleMessage(
      "La búsqueda coincide con nombres de archivos y carpetas del directorio actual.",
    ),
    ...
    "conversationModelDescription": MessageLookupByLibrary.simpleMessage(
      "El modelo que genera las respuestas de esta conversación.",
    ),
    ...
    "conversationNameDescription": MessageLookupByLibrary.simpleMessage(
      "El nombre personalizado que identifica esta conversación.",
    ),
    "conversationNamePlaceholder": MessageLookupByLibrary.simpleMessage(
      "Introduce un nombre para la conversación",
    ),
    ...
    "conversationProviderDescription": MessageLookupByLibrary.simpleMessage(
      "El proveedor del servicio de modelo para esta conversación.",
    ),
    ...
    "deepThinkingDescription": MessageLookupByLibrary.simpleMessage(
      "Permite que el modelo razone con mayor profundidad antes de responder.",
    ),
    ...
    "estimatedContextUsageDescription": MessageLookupByLibrary.simpleMessage(
      "Tokens estimados para la próxima solicitud frente al presupuesto de entrada disponible.",
    ),
    ...
    "hideConversationInformation": MessageLookupByLibrary.simpleMessage(
      "Ocultar información de la conversación",
    ),
    ...
    "inputTokensDescription": MessageLookupByLibrary.simpleMessage(
      "Tokens enviados al modelo, incluidos el contexto de la conversación y las instrucciones.",
    ),
    "installSkillUpdate": MessageLookupByLibrary.simpleMessage(
      "Instalar actualización",
    ),
    "invalidBotExport": MessageLookupByLibrary.simpleMessage(
      "Este archivo no es una exportación válida de un bot de Stars.",
    ),
    ...
    "maxToolRequestRoundsDescription": MessageLookupByLibrary.simpleMessage(
      "Número máximo de rondas del modelo que pueden solicitar herramientas en una respuesta. Este ajuste solo se aplica a esta conversación.",
    ),
    ...
    "maxToolRequestRoundsSaved": MessageLookupByLibrary.simpleMessage(
      "Límite de rondas de herramientas actualizado.",
    ),
    ...
    "outputTokensDescription": MessageLookupByLibrary.simpleMessage(
      "Tokens generados por el modelo en sus respuestas.",
    ),
    ...
    "renameConversationDescription": MessageLookupByLibrary.simpleMessage(
      "Elige un nombre claro para encontrar esta conversación más fácilmente.",
    ),
    ...
    "retainedRecentTurnsDescription": MessageLookupByLibrary.simpleMessage(
      "Turnos recientes de la conversación conservados en su forma original.",
    ),
    ...
    "showVerificationStatusDescription": MessageLookupByLibrary.simpleMessage(
      "Muestra el estado y los detalles de la verificación en los mensajes del asistente.",
    ),
    ...
    "summarizedTurnsDescription": MessageLookupByLibrary.simpleMessage(
      "Mensajes ya comprimidos en el resumen de la conversación.",
    ),
    ...
    "totalTokensDescription": MessageLookupByLibrary.simpleMessage(
      "Total de tokens de entrada y salida usados durante el período seleccionado.",
    ),
    ...
    "unableToRenameConversation": MessageLookupByLibrary.simpleMessage(
      "No se pudo cambiar el nombre de la conversación",
    ),
    ...
    "webSearchDescription": MessageLookupByLibrary.simpleMessage(
      "Permite que el modelo busque información actualizada en la web.",
    ),
  };
}
