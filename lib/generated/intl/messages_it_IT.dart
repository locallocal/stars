...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m25(index, summary) =>
      "Vai al messaggio utente ${index}: ${summary}";

  static String m26(language) => "Lingua impostata a ${language}";

  static String m27(error) => "MCP connection failed: ${error}";

  static String m28(count) => "${count} configured (values hidden)";

  static String m29(minutes) => "${minutes} minuti fa";

  static String m30(count) => "${count} modelli recuperati con successo";

  static String m31(count) => "${count} esecuzioni di comandi";

  static String m32(duration) => "Durata ${duration}";

  static String m33(count) => "${count} modifiche ai file";

  static String m34(count) => "${count} chiamate agli strumenti";

  static String m35(error) => "Impossibile ottenere risposta: ${error}";
  ...
  static String m39(question, reason) =>
      "Non posso fornire una risposta fattuale affidabile a «${question}», quindi non farò supposizioni.\n\nStato della verifica: ${reason}\n\nPuoi controllare i dettagli delle prove, fornire una fonte affidabile o chiedermi di verificare di nuovo.";

  static String m40(duration) => "Elaborazione completata · ${duration}";

  static String m41(error) => "Errore di riproduzione video: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "answerTrustClaimHidden": MessageLookupByLibrary.simpleMessage(
      "La modalità rigorosa ha nascosto l\'affermazione fattuale non verificata.",
    ),
    "answerTrustDetails": MessageLookupByLibrary.simpleMessage(
      "Mostra dettagli delle prove",
    ),
    "answerTrustEvidence": MessageLookupByLibrary.simpleMessage("Prova"),
    "answerTrustEvidenceUnavailable": MessageLookupByLibrary.simpleMessage(
      "I dettagli della prova non sono disponibili.",
    ),
    "answerTrustExportReason": MessageLookupByLibrary.simpleMessage(
      "Motivo di attendibilità",
    ),
    "answerTrustExportStatus": MessageLookupByLibrary.simpleMessage(
      "Stato di attendibilità",
    ),
    ...
    "answerTrustNotFactChecked": MessageLookupByLibrary.simpleMessage(
      "Non sottoposto a verifica dei fatti",
    ),
    "answerTrustObservedAt": MessageLookupByLibrary.simpleMessage("Osservato"),
    ...
    "answerTrustReasonEvidenceExpired": MessageLookupByLibrary.simpleMessage(
      "L\'osservazione di supporto è scaduta.",
    ),
    ...
    "answerTrustReasonGenerationTimedOut": MessageLookupByLibrary.simpleMessage(
      "La generazione è scaduta prima della verifica della risposta finale. Le prove degli strumenti completate restano disponibili.",
    ),
    ...
    "answerTrustReasonNotFactChecked": MessageLookupByLibrary.simpleMessage(
      "Questo contenuto è creativo o non viene presentato come fatto verificato.",
    ),
    "answerTrustReasonPartiallyVerified": MessageLookupByLibrary.simpleMessage(
      "Solo alcune affermazioni fattuali sono supportate da prove salvate.",
    ),
    ...
    "answerTrustReasonVerified": MessageLookupByLibrary.simpleMessage(
      "Tutte le affermazioni fattuali sono supportate da prove salvate.",
    ),
    "answerTrustSemanticLabel": m0,
    "answerTrustSource": MessageLookupByLibrary.simpleMessage("Fonte"),
    "answerTrustTool": MessageLookupByLibrary.simpleMessage("Strumento"),
    "answerTrustUnverified": MessageLookupByLibrary.simpleMessage(
      "Non verificato",
    ),
    "answerTrustVerified": MessageLookupByLibrary.simpleMessage("Verificato"),
    ...
    "conversationDataMenuLabel": MessageLookupByLibrary.simpleMessage("Dati"),
    ...
    "conversationFileSearchEmptyDescription":
        MessageLookupByLibrary.simpleMessage(
          "Prova un altro nome di file o cartella oppure cancella la ricerca.",
        ),
    "conversationFileSearchScope": MessageLookupByLibrary.simpleMessage(
      "La ricerca confronta i nomi di file e cartelle nella directory corrente.",
    ),
    ...
    "conversationNameDescription": MessageLookupByLibrary.simpleMessage(
      "Il nome personalizzato che identifica questa conversazione.",
    ),
    ...
    "hideConversationInformation": MessageLookupByLibrary.simpleMessage(
      "Nascondi informazioni sulla conversazione",
    ),
    ...
    "maxToolRequestRounds": MessageLookupByLibrary.simpleMessage(
      "Limite turni richieste strumenti",
    ),
    "maxToolRequestRoundsDescription": MessageLookupByLibrary.simpleMessage(
      "Numero massimo di turni del modello che possono richiedere strumenti in una risposta. Questa impostazione si applica solo a questa conversazione.",
    ),
    "maxToolRequestRoundsRange": MessageLookupByLibrary.simpleMessage(
      "Inserisci un numero intero da 1 a 50.",
    ),
    "maxToolRequestRoundsSaved": MessageLookupByLibrary.simpleMessage(
      "Limite dei turni per le richieste di strumenti aggiornato.",
    ),
    ...
    "modelLogCopied": MessageLookupByLibrary.simpleMessage("Copiato"),
    "modelLogCopyFailed": MessageLookupByLibrary.simpleMessage(
      "Impossibile copiare il percorso. Selezionalo e copialo manualmente.",
    ),
    "modelLogCopyPath": MessageLookupByLibrary.simpleMessage("Copia percorso"),
    "modelLogDirectory": MessageLookupByLibrary.simpleMessage(
      "Cartella dei log di questa conversazione",
    ),
    ...
    "modelLogOpenFailed": MessageLookupByLibrary.simpleMessage(
      "Impossibile aprire la cartella. Copia il percorso per aprirla manualmente.",
    ),
    "modelLogSaveFailed": MessageLookupByLibrary.simpleMessage(
      "Impossibile salvare. Rimane attiva l’impostazione precedente.",
    ),
    "modelLogWriteFailed": MessageLookupByLibrary.simpleMessage(
      "Impossibile scrivere i log. Controlla permessi e spazio libero. Le richieste non sono interessate.",
    ),
    ...
    "modelRequestLogging": MessageLookupByLibrary.simpleMessage(
      "Log delle richieste al modello",
    ),
    "modelRequestLoggingDescription": MessageLookupByLibrary.simpleMessage(
      "Salva in locale solo richieste e risposte di questa conversazione, incluso il testo. Credenziali e dati allegati vengono nascosti.",
    ),
    "modelRequestLoggingRetention": MessageLookupByLibrary.simpleMessage(
      "Disattivato per ogni conversazione. Fino a 5 file da 10 MB ciascuno.",
    ),
    ...
    "renameConversationDescription": MessageLookupByLibrary.simpleMessage(
      "Scegli un nome chiaro per trovare più facilmente questa conversazione.",
    ),
    ...
    "showReasoningDescription": MessageLookupByLibrary.simpleMessage(
      "Mostra il processo di ragionamento nei messaggi dell’assistente.",
    ),
    ...
    "strictGroundingMode": MessageLookupByLibrary.simpleMessage(
      "Modalità di verifica rigorosa",
    ),
    "strictGroundingModeDescription": MessageLookupByLibrary.simpleMessage(
      "Nasconde le risposte fattuali non verificate mantenendo i dettagli di verifica e degli errori degli strumenti.",
    ),
    "strictGroundingUnableToVerify": MessageLookupByLibrary.simpleMessage(
      "Non dispongo di prove affidabili sufficienti per fornire una risposta fattuale, quindi non farò supposizioni. Controlla i dettagli delle prove, fornisci una fonte affidabile o chiedimi di verificare di nuovo.",
    ),
    ...
    "toolStateNotReadBackVerified": MessageLookupByLibrary.simpleMessage(
      "Stato non riletto come verificato",
    ),
    ...
    "unableToRenameConversation": MessageLookupByLibrary.simpleMessage(
      "Impossibile rinominare la conversazione",
    ),
