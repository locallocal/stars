...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m25(index, summary) =>
      "Ir para a mensagem do usuário ${index}: ${summary}";

  static String m26(language) => "Idioma alterado para ${language}";

  static String m27(error) => "MCP connection failed: ${error}";

  static String m28(count) => "${count} configured (values hidden)";

  static String m29(minutes) => "há ${minutes} minutos";

  static String m30(count) => "${count} modelos recuperados com sucesso";

  static String m31(count) => "${count} execuções de comando";

  static String m32(duration) => "Duração ${duration}";

  static String m33(count) => "${count} alterações de arquivo";

  static String m34(count) => "${count} chamadas de ferramenta";

  static String m35(error) => "Falha ao obter resposta: ${error}";
  ...
  static String m39(question, reason) =>
      "Não posso dar uma resposta factual confiável para “${question}”, então não vou adivinhar.\n\nStatus da verificação: ${reason}\n\nVocê pode conferir os detalhes das evidências, fornecer uma fonte confiável ou pedir uma nova verificação.";

  static String m40(duration) => "Pensamento concluído · ${duration}";

  static String m41(error) => "Erro na reprodução do vídeo: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "answerTrustClaimHidden": MessageLookupByLibrary.simpleMessage(
      "O modo estrito ocultou a afirmação factual não verificada.",
    ),
    "answerTrustDetails": MessageLookupByLibrary.simpleMessage(
      "Mostrar detalhes das evidências",
    ),
    "answerTrustEvidence": MessageLookupByLibrary.simpleMessage("Evidência"),
    "answerTrustEvidenceUnavailable": MessageLookupByLibrary.simpleMessage(
      "Os detalhes da evidência não estão disponíveis.",
    ),
    ...
    "answerTrustReasonEvidenceExpired": MessageLookupByLibrary.simpleMessage(
      "A observação de suporte expirou.",
    ),
    ...
    "answerTrustReasonGenerationTimedOut": MessageLookupByLibrary.simpleMessage(
      "A geração expirou antes da verificação da resposta final. As evidências de ferramentas concluídas continuam disponíveis.",
    ),
    ...
    "answerTrustReasonNotFactChecked": MessageLookupByLibrary.simpleMessage(
      "Este conteúdo é criativo ou não é apresentado como fato verificado.",
    ),
    "answerTrustReasonPartiallyVerified": MessageLookupByLibrary.simpleMessage(
      "Apenas algumas afirmações factuais têm suporte de evidências salvas.",
    ),
    ...
    "answerTrustReasonVerified": MessageLookupByLibrary.simpleMessage(
      "Todas as afirmações factuais têm suporte de evidências salvas.",
    ),
    "answerTrustSemanticLabel": m0,
    "answerTrustSource": MessageLookupByLibrary.simpleMessage("Fonte"),
    "answerTrustTool": MessageLookupByLibrary.simpleMessage("Ferramenta"),
    ...
    "automaticMemoryDescription": MessageLookupByLibrary.simpleMessage(
      "Resume automaticamente mensagens antigas quando o contexto precisa de espaço.",
    ),
    ...
    "botExportFailed": MessageLookupByLibrary.simpleMessage(
      "Não foi possível exportar o bot. Tente novamente.",
    ),
    "botExportSucceeded": MessageLookupByLibrary.simpleMessage("Bot exportado"),
    "botExportedWithoutSecrets": MessageLookupByLibrary.simpleMessage(
      "As chaves de API nunca são incluídas nos arquivos de exportação de bots.",
    ),
    "botGreeting": m3,
    "botImportFailed": MessageLookupByLibrary.simpleMessage(
      "Não foi possível importar o bot. Verifique o arquivo e tente novamente.",
    ),
    "botImportSucceeded": MessageLookupByLibrary.simpleMessage("Bot importado"),
    "botImportedWithoutApiKey": MessageLookupByLibrary.simpleMessage(
      "Por segurança, as chaves de API não são importadas. Adicione uma antes de usar este bot.",
    ),
    ...
    "compactionStatusDescription": MessageLookupByLibrary.simpleMessage(
      "Estado atual da compactação automática do contexto.",
    ),
    ...
    "contextWindowDescription": MessageLookupByLibrary.simpleMessage(
      "Número máximo de tokens que o modelo pode considerar em uma solicitação.",
    ),
    "conversationBotDescription": MessageLookupByLibrary.simpleMessage(
      "O bot usado por esta conversa.",
    ),
    "conversationClearMenuLabel": MessageLookupByLibrary.simpleMessage(
      "Limpar",
    ),
    "conversationDataMenuLabel": MessageLookupByLibrary.simpleMessage("Dados"),
    ...
    "conversationFileSearchEmptyDescription":
        MessageLookupByLibrary.simpleMessage(
          "Tente outro nome de arquivo ou pasta, ou limpe a pesquisa.",
        ),
    "conversationFileSearchScope": MessageLookupByLibrary.simpleMessage(
      "A pesquisa corresponde aos nomes de arquivos e pastas no diretório atual.",
    ),
    ...
    "conversationProviderDescription": MessageLookupByLibrary.simpleMessage(
      "O provedor do serviço de modelo para esta conversa.",
    ),
    ...
    "deepThinkingDescription": MessageLookupByLibrary.simpleMessage(
      "Permite que o modelo raciocine mais profundamente antes de responder.",
    ),
    ...
    "estimatedContextUsageDescription": MessageLookupByLibrary.simpleMessage(
      "Tokens estimados para a próxima solicitação em relação ao orçamento de entrada disponível.",
    ),
    ...
    "importBot": MessageLookupByLibrary.simpleMessage("Importar bot"),
    ...
    "inputTokensDescription": MessageLookupByLibrary.simpleMessage(
      "Tokens enviados ao modelo, incluindo o contexto da conversa e as instruções.",
    ),
    "installSkillUpdate": MessageLookupByLibrary.simpleMessage(
      "Instalar atualização",
    ),
    "invalidBotExport": MessageLookupByLibrary.simpleMessage(
      "Este arquivo não é uma exportação válida de bot do Stars.",
    ),
    ...
    "modelInputModalitiesDescription": MessageLookupByLibrary.simpleMessage(
      "Os tipos de conteúdo que este modelo pode processar.",
    ),
    "modelLogCopied": MessageLookupByLibrary.simpleMessage("Copiado"),
    "modelLogCopyFailed": MessageLookupByLibrary.simpleMessage(
      "Não foi possível copiar o caminho. Selecione e copie manualmente.",
    ),
    "modelLogCopyPath": MessageLookupByLibrary.simpleMessage("Copiar caminho"),
    "modelLogDirectory": MessageLookupByLibrary.simpleMessage(
      "Pasta de logs desta conversa",
    ),
    ...
    "modelLogOpenFailed": MessageLookupByLibrary.simpleMessage(
      "Não foi possível abrir a pasta. Copie o caminho para abrir manualmente.",
    ),
    ...
    "modelLogWriteFailed": MessageLookupByLibrary.simpleMessage(
      "Não foi possível gravar logs. Verifique permissões e espaço livre. As solicitações não são afetadas.",
    ),
    ...
    "modelOutputModalitiesDescription": MessageLookupByLibrary.simpleMessage(
      "Os tipos de conteúdo que este modelo pode gerar.",
    ),
    "modelRequestLogging": MessageLookupByLibrary.simpleMessage(
      "Logs de solicitações ao modelo",
    ),
    "modelRequestLoggingDescription": MessageLookupByLibrary.simpleMessage(
      "Salva localmente apenas solicitações e respostas desta conversa, incluindo o texto. Credenciais e dados de anexos ficam ocultos.",
    ),
    "modelRequestLoggingRetention": MessageLookupByLibrary.simpleMessage(
      "Desativado por padrão em cada conversa. Até 5 arquivos de 10 MB cada.",
    ),
    "modelTurnLimitReached": MessageLookupByLibrary.simpleMessage(
      "O modelo atingiu o limite de turnos de processamento. Simplifique a solicitação e tente novamente.",
    ),
    ...
    "renameConversationDescription": MessageLookupByLibrary.simpleMessage(
      "Escolha um nome claro para encontrar esta conversa com mais facilidade.",
    ),
    ...
    "retainedRecentTurnsDescription": MessageLookupByLibrary.simpleMessage(
      "Turnos recentes da conversa mantidos na forma original.",
    ),
    ...
    "showReasoningDescription": MessageLookupByLibrary.simpleMessage(
      "Mostra o processo de raciocínio nas mensagens do assistente.",
    ),
    ...
    "showVerificationStatusDescription": MessageLookupByLibrary.simpleMessage(
      "Mostra o status e os detalhes da verificação nas mensagens do assistente.",
    ),
    ...
    "strictGroundingMode": MessageLookupByLibrary.simpleMessage(
      "Modo de verificação estrito",
    ),
    "strictGroundingModeDescription": MessageLookupByLibrary.simpleMessage(
      "Oculta respostas factuais não verificadas e mantém detalhes de verificação e falhas das ferramentas.",
    ),
    "strictGroundingUnableToVerify": MessageLookupByLibrary.simpleMessage(
      "Não tenho evidências confiáveis suficientes para dar uma resposta factual, então não vou adivinhar. Confira os detalhes das evidências, forneça uma fonte confiável ou peça uma nova verificação.",
    ),
    ...
    "summarizedTurnsDescription": MessageLookupByLibrary.simpleMessage(
      "Mensagens já compactadas no resumo da conversa.",
    ),
    ...
    "toolActionAccepted": MessageLookupByLibrary.simpleMessage("Ação aceita"),
    ...
    "totalTokensDescription": MessageLookupByLibrary.simpleMessage(
      "Total de tokens de entrada e saída usados no período selecionado.",
    ),
    ...
    "webSearchDescription": MessageLookupByLibrary.simpleMessage(
      "Permite que o modelo pesquise informações atualizadas na Web.",
    ),
  };
}
